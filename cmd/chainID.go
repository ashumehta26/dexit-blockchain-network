...
func init() {
	rootCmd.AddCommand(govindcmd)
}
// startCmd represents the start command
var govindcmd = &cobra.Command{
	Use:   "govind",
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		cont, err :=  NewCD(common.HexToAddress("0x83318095186B28f8195d29c1902c1288381406F8"), client)
		if err != nil {
			log.Fatal(err)
		}
		//amount := big.NewInt(1000);
		methodname, err := cont.GetchainID(nil)
		if err != nil {
			log.Fatal(err)
		}
